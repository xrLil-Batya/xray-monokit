...
void CCC_RegisterCommands()
{
	...
	if(g_dedicated_server || psDeviceFlags.test(rsR4))
	{
		psDeviceFlags.set(AF_3D_PDA, true);
		CMD3(CCC_Mask, "g_3d_pda", &psDeviceFlags, AF_3D_PDA);
	}
	else
		psDeviceFlags.set(AF_3D_PDA, false);
